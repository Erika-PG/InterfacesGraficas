...
public class MarcoCasillaVerificacion extends JFrame {
     private JTextField campoTexto; //Muestra el texto en tipos de letras cambiantes
    ...
    public MarcoCasillaVerificacion()
    {
        ...
        campoTexto = new JTextField("Observe how the font style changes", 20);
        ...
        ManejadorCheckBox manejador = new
                ManejadorCheckBox();
    ...
    private class ManejadorCheckBox implements ItemListener {
        ...
        public void itemStateChanged(ItemEvent evento) {
            ...
            if (negritaJCheckBox.isSelected() &&
                ...
                tipoletra = new Font("Serif", Font.BOLD + Font.ITALIC,
                        14);
